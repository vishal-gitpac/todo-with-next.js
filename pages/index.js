...
const url = "https://todo-with-next-js-vercel.vercel.app/api/task";
...
export default function Home(props) {
  ...
  //task is state variable
  //task has ._id, .task, .completed
  const addTask = async (e) => {
    //This is to prevent the default behaviour of the form
    //default behaviour of the form is to reload the page
    e.preventDefault();
    try {
      if (task._id) {
